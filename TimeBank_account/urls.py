...
urlpatterns = [
    ...
    path('register/<str:username>/register_profile', views.register_profile, name='register_profile'),
    path('register/<str:username>/register_profile_page', views.register_profile_page, name='register_profile_page'),
    ...
    path('<str:username>/balance/balance_search', views.balance_search, name="balance_search"),
    path('<str:username>/balance/balance_search/gift', views.gift, name="gift"),
