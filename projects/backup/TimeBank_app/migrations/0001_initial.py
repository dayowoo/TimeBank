    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applicants', models.ManyToManyField(blank=True, related_name='apply_user', through='TimeBank_app.Apply', to='TimeBank_app.Post')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='작성자')),
                ('giver', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='give_user', to=settings.AUTH_USER_MODEL, verbose_name='주는사람')),
                ('taker', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='take_user', to=settings.AUTH_USER_MODEL, verbose_name='받는사람')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.AddField(
            model_name='apply',
            name='from_post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='apply_post', to='TimeBank_app.post'),
        ),
        migrations.AddField(
            model_name='apply',
            name='to_user',
