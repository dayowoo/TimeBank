...
class Post(models.Model): 
    ...
    giver = models.ForeignKey('TimeBank_account.User', related_name="Post.giver", on_delete=models.CASCADE, verbose_name='주는사람', null=True)
    taker = models.ForeignKey('TimeBank_account.User', related_name="Post.taker", on_delete=models.CASCADE, verbose_name='받는사람', null=True)
